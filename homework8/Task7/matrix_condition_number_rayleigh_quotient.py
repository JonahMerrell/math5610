...
from _mymodules import matrix_rayleigh_quotient_iteration, matrix_inverse_power_iteration

def matrix_condition_number(matrix):
    largest_eigenvalue = matrix_rayleigh_quotient_iteration(matrix,0.00000000000001,20000)
    smallest_eigenvalue = matrix_inverse_power_iteration(matrix,0,0.0000000001,20000)
